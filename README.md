...
##############################################################################
**CNN_CIFAR10:** Build and train a simple Convolutional Neural Network (CNN) to classify images from the CIFAR-10 dataset using TensorFlow and Keras. it trains, evaluates the model and generates the predicted image.
